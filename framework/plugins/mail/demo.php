...
function sendMail($to, $SMTP=true, $paraArr=array())
{
    ...
    extract($paraArr);
    //发送方
    $user = isset($user)?$user:'fortuan800@126.com';
    $pswd = isset($pswd)?$pswd:'12345678';
    ...
    if($SMTP) {
        ...
        $mail->SetFrom('fortuan800@126.com', 'From');
        $mail->AddReplyTo("fortuan800@126.com", "Last");
        $address = $to;
...
sendMail('ctymtce@sina.com', true, array('body'=>'this is a test'));
// sendMail('fortuan800@126.com', true, array('body'=>'this is a test'));
?>
